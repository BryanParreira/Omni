...
║                                                                     ║
║  🤖 HYBRID LLM BACKEND                                              ║
║     Choose between major cloud providers (OpenAI, Anthropic,        ║
║     Google Gemini) or run models entirely locally with deep         ║
║     Ollama integration (Llama 3, Mistral, CodeLlama, and more)      ║
║                                                                     ║
║  ─────────────────────────────────────────────────────────────────  ║
║                                                                     ║
...
1. **Unzip the File**: Download the release and unzip the folder.
2. **Move the App**: Open the unzipped folder and drag `Omni.app` into your Applications folder.
3. **Authorize the App**: Open the Terminal app and run the following command. This fixes the "App is damaged" error caused by macOS quarantine:

```bash
xattr -cr /Applications/Omni.app
```

4. **You are good to go!** Launch Omni from your Applications folder.
...
| Step | Action |
|------|--------|
| **STEP 1** | **Launch Omni**<br>The app runs silently in your menu bar after launch |
| **STEP 2** | **Summon the Interface**<br>Press `⌥ + Space` anywhere on your Mac |
| **STEP 3** | **Start Chatting**<br>Type any question, request, or drag-and-drop files directly into the input field |
